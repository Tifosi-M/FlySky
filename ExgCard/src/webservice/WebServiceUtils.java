...
public class WebServiceUtils {
	...
	private <T> Object call(String methodName, HashMap<String, Object> args,
		...
		if (methodName.equals("updateCardDBFileInsertInfo")) {
			UserCard userCard = new UserCard();
			userCard = (UserCard) args.get("myCardInfo");
			PropertyInfo piInfo = new PropertyInfo();
			piInfo.setName("myCardInfo");
			piInfo.setValue(userCard);
			piInfo.setType(userCard.getClass());
			requestSoapObject.addProperty(piInfo);
			requestSoapObject.addProperty("tel", args.get("tel"));
		} else {
			if (args != null) {
		...
		if (methodName.equals("uploadCardDBFile")) {
